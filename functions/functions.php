...
$db = mysqli_connect("localhost", "root", "", "jemcloset_store");
...
function add_cart()
{
    ...
    if (isset($_GET['add_cart'])) {
        ...
        $check_product = "select * from cart where CUSTOMER_ID='$c_id' AND PRODUCT_ID='$p_id'";
        ...
        if (mysqli_num_rows($run_check) > 0) {
            ...
            $query = "insert into cart (CUSTOMER_ID,PRODUCT_ID,QUANTITY,SIZE) values ('$c_id','$p_id','$product_qty','$product_size')";
...
function getPro()
{
    ...
    $get_products = "select * from clothes_products order by 1 DESC LIMIT 0,8";
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='col-md-4 col-sm-6 col-12 single'>
...
function getpcatpro()
{
    ...
    if (isset($_GET['p_cat'])) {
        ...
        $get_p_cat = "select * from clothes_categories where CLOTHES_CATEGORY_ID='$p_cat_id'";
        ...
        $p_cat_desc = $row_p_cat['DESCRIPTION'];

        $get_products = "select * from clothes_products where CLOTHES_CATEGORY_ID='$p_cat_id'";
...
function total_price()
{
    ...
    while ($record = mysqli_fetch_array($run_cart)) {
        ...
        $get_price = "select * from clothes_products where PRODUCT_ID='$pro_id'";
