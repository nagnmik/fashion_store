    ...
    <div class="container"><!-- container Begin -->
        ...
        <div class="col-md-9"><!-- col-md-9 Begin -->
            <div id="productMain" class="row"><!-- row Begin -->
                ...
                <div class="col-sm-6"><!-- col-sm-6 Begin -->
                    <div class="box"><!-- box Begin -->
                        <h3 class="text-left"> <?php echo $pro_title; ?> </h3>
                        ...
                        <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                            ...
                            <p class="text-center buttons"><button class="btn btn-cart i fa fa-shopping-cart"> Add to cart</button></p>
            ...
            <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                ...
                $get_products = "select * from clothes_products order by rand() LIMIT 0,3";
