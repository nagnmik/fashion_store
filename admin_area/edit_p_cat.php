...
?>
    ...
    if (isset($_GET['edit_p_cat'])) {
        ...
        $edit_p_cat_query = "select * from clothes_categories where CLOTHES_CATEGORY_ID='$edit_p_cat_id'";

        $run_edit = mysqli_query($con, $edit_p_cat_query);

        $row_edit = mysqli_fetch_array($run_edit);

        $p_cat_id = $row_edit['CLOTHES_CATEGORY_ID'];

        $p_cat_title = $row_edit['CATEGORY'];
    ...
    if (isset($_POST['update'])) {
        ...
        $update_p_cat = "update clothes_categories set CATEGORY='$p_cat_title',DESCRIPTION='$p_cat_desc' where CLOTHES_CATEGORY_ID='$p_cat_id'";
