...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_user = "insert into admins (ADMIN_ID, NAME, EMAIL, PASS,IMAGE,COUNTRY,ABOUT, PHONE, JOB) values ('$user_id','$user_name','$user_email','$user_pass','$user_image','$user_country','$user_about','$user_contact','$user_job')";
