...
?>
    ...
    if (isset($_GET['edit_slide'])) {
        ...
        $slide_name = $row_edit_slide['NAME'];

        $slide_image = $row_edit_slide['IMAGE'];
    }
    ...
    if (isset($_POST['update'])) {
        ...
        $update_slide = "update slider set NAME='$slide_name',IMAGE='$slide_image' where SLIDER_ID='$slide_id'";
