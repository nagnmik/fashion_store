...
?>
    ...
    if (isset($_POST['update'])) {
        ...
        $update_user = "update admins set NAME='$user_name',EMAIL='$user_email',PASS='$user_pass',COUNTRY='$user_country',PHONE='$user_contact',JOB='$user_job',ABOUT='$user_about',IMAGE='$user_image' where ADMIN_ID='$user_id'";
