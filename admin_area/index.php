...
if (!isset($_SESSION['ADMIN_ID'])) {
        ...
        $get_admin = "select * from admins where ADMIN_ID='$admin_session'";
        ...
        $get_products = "select * from clothes_products";
        ...
        $get_p_categories = "select * from clothes_categories";

        $run_p_categories = mysqli_query($con, $get_p_categories);

        $count_p_categories = mysqli_num_rows($run_p_categories);

        $get_orders = "select * from orders where STATUS like '%xử%' or STATUS like '%toán%' or STATUS like '%Xác%'";
...
?>
        ...
        <head>
                ...
                <title>Jemcloset Store Admin Area</title>
