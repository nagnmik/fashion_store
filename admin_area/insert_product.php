...
?>
                            ...
                            <div class="form-group"><!-- form-group Begin -->
                                ...
                                <div class="col-md-6"><!-- col-md-6 Begin -->
                                    ...
                                    <select name="product_brand" class="form-control"><!-- form-control Begin -->
                                        ...
                                        <option> Select a Brand Product </option>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_product = "insert into clothes_products (PRODUCT_ID,CLOTHES_CATEGORY_ID,BRAND_ID,NAME,DESCRIPTION,IMAGE_1,IMAGE_2,IMAGE_3,price,KEYWORDS,STOCK,DATE_CREATED) values ('$product_id','$product_cat','$product_brand','$product_title','$product_desc','$product_img1','$product_img2','$product_img3','$product_price','$product_keywords', '$product_stock', NOW())";
