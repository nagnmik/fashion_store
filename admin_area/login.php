...
<body>
    ...
    <div class="container"><!-- container begin -->
        <form action="" class="form-login" method="post"><!-- form-login begin -->
            ...
            <button type="submit" class="btn btn-lg btn-login btn-block" name="admin_login"><!-- btn btn-lg btn-primary btn-block begin -->
...
if (isset($_POST['admin_login'])) {
    ...
    $get_admin = "select * from admins where EMAIL='$admin_email' AND PASS='$admin_pass'";
