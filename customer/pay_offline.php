...
$insert_orders = "insert into orders (ORDER_ID,CUSTOMER_ID,SHIPPING_ID,total,PAYMENT_METHOD, SHIPPING_ADDRESS, NOTE, CREATED_ON,SHIPPING_ON,STATUS) values ('$o_id','$customer_id','$shipping_id','0','Thanh toán khi nhận hàng','','',NOW(),'$shipping_on', '$status')";
