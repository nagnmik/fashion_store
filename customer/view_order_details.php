                ...
                <div class="panel-body">
                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="col-md-2">
                                <img class="img-responsive" src="../admin_area/product_images/<?php echo $image_product; ?>" alt="Product 3a">
                            </div>
                            <div class="col-md-10">
                    ...
                    <div class="table-responsive"><!-- table-responsive begin -->
                        ...
                        <a href="my_account.php?cancel_order=<?php echo $order_id; ?>" class="btn btn-danger">
