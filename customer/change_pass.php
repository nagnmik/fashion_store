...
if (isset($_POST['submit'])) {
    ...
    $sel_c_old_pass = "select * from customers where CUSTOMER_ID='$c_id'";

    $run_c_old_pass = mysqli_query($con, $sel_c_old_pass);

    $check_c_old_pass = mysqli_fetch_array($run_c_old_pass);

    $customer_pass = $check_c_old_pass['PASS'];

    if ($customer_pass != $c_old_pass) {
    ...
    $update_c_pass = "update customers set PASS='$c_new_pass' where CUSTOMER_ID='$c_id'";
